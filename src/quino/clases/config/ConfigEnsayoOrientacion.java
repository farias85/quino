...
public class ConfigEnsayoOrientacion extends ConfigEnsayoEnrejado {
    ...
    public ConfigEnsayoOrientacion(int key, int panelEstimulo, int fs, double fspa_cpi_x,
            double fspa_cpi_y, double ppi, double fspa_cpp_x, double fspa_cpp_y, boolean sentidoUpLeft,
    ...
    public ConfigEnsayoOrientacion(int direccion, double ppi, boolean onMove,
