 ...
 * @author Casa
 */
public class OrientacionTestView extends javax.swing.JDialog {

    private PrincipalView parent;

    public OrientacionTestView() {
    }

    public OrientacionTestView(PrincipalView parent, boolean modal, boolean practica) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                OrientacionTestView dialog = new OrientacionTestView();
