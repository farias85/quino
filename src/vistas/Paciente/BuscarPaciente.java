...
public class BuscarPaciente extends javax.swing.JDialog {
    ...
    Principal parent;
    int pos;
    public BuscarPaciente(Principal parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.parent=parent;
    ...
    private void cambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cambiosActionPerformed
        ...
        try{
            ...
            Errores er = new Errores(parent, true, "Cambos realizados exitosamente");
            er.setVisible(true);
            parent.Mod_Tabla();
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        ...
        try{
            ...
            Errores err = new Errores(parent, true, "El Paciente ha sido eliminado satisfactoriamente");
            err.setVisible(true);
            historia.setText("");
            nombre.setText("");
            CI.setText("");
    ...
    private void pruebaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pruebaActionPerformed
        // TODO add your handling code here:
        RealizarPrueba rp = new RealizarPrueba(parent, true);
        rp.setVisible(true);
        setVisible(false);
        dispose();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscarPaciente dialog = new BuscarPaciente(new Principal(), true);
