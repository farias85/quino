 ...
 * @author Davisito
 */
public class Configuracion_Avanzada extends javax.swing.JDialog {
    Principal parent;
    /** Creates new form Configuracion_Avanzada */
    public Configuracion_Avanzada(Principal parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.parent = parent;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        catch(Exception e)
        {
            ...
            Errores err = new Errores(parent, true, msg);
            err.setVisible(true);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Configuracion_Avanzada dialog = new Configuracion_Avanzada(new Principal(), true);
