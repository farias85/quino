 ...
 * @author Casa
 */
public class ManualPerifericaTimer extends TimerTask {
    ...
    public ManualPerifericaTimer(Prueba prueba, Configuracion configuracion, QuinoJPanel panel1, QuinoJPanel panel2, CentralJPanel panel3, PerifericaTestView test) {
        this.prueba = prueba;
        this.configuracion = configuracion;
        this.panel1 = panel1;
        this.panel2 = panel2;
