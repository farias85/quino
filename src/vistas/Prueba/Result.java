...
public class Result extends javax.swing.JDialog {
    ...
    public Result(Principal parent, boolean modal, Prueba prueba) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        t_direccion1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vistas/Iconos/vacio.gif"))); // NOI18N
        t_direccion1.setBorder(null);

        t_resultado1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vistas/Iconos/vacio.gif"))); // NOI18N
        ...
        b_keypressed.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vistas/Iconos/vacio.gif"))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Result dialog = new Result(new Principal(), true, new Prueba());
