 ...
 * @author Davisito
 */
public class MyCTimer extends TimerTask{
    ...
    public MyCTimer(Prueba prueba) {
        this.prueba = prueba;
    }

    public MyCTimer(Prueba prueba, Configuracion configuracion, MyJPanel panel1, MyJPanel panel2, MyJPanel panel3, MyJPanel panel4, MyJPanel panel5, MyJPanel panel6, MyJPanel panel7, MyJPanel panel8, MyMJPanel panel9,Central_Test test) {
        this.prueba = prueba;
