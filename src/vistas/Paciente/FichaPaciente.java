 ...
 * @author Davisito
 */
public class FichaPaciente extends javax.swing.JDialog {

    /** Creates new form FichaPaciente */
    int pos;
    Principal parent;
    public FichaPaciente(Principal parent, boolean modal, int pos) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FichaPaciente dialog = new FichaPaciente(new Principal(), true, 0);
