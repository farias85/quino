 ...
 * @author davisito
 */
public class Configuración_Manual extends javax.swing.JDialog {
    ...
    public Configuración_Manual(Principal parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            if(fobeal){
                 ...
                 Central_Test t = new Central_Test(parent, true, parent.prueba, parent.configuracion, false, false);
                 t.setVisible(true);
                 setVisible(false);
                 dispose();
            }else{
                ...
                Test t = new Test(parent, true, parent.prueba, parent.configuracion, false, false);
                t.setVisible(true);
                setVisible(false);
                dispose();
            }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Configuración_Manual dialog=new Configuración_Manual(new Principal(), true);
