 ...
 * @author Felipao
 */
public abstract class ZAbstractQuinoTimer extends TimerTask {
    ...
    public ZAbstractQuinoTimer(Prueba prueba, Configuracion configuracion) {
        this.prueba = prueba;
     ...
     */
    protected ZEstadoEnsayo estadoEnsayo() {
        if (tiempoTranscurrido <= enEspera) {
            return ZEstadoEnsayo.EN_ESPERA;
        } else if (tiempoTranscurrido <= enEspera + preparado) {
            return ZEstadoEnsayo.PREPARADO;
        } else if (tiempoTranscurrido == enEspera + preparado + 1) {
            return ZEstadoEnsayo.EJECUTANDO_MOVIMIENTO;
        } else if (tiempoTranscurrido < enEspera + preparado + esperandoRespuesta - 1) {
            return ZEstadoEnsayo.ESPERANDO_RESPUESTA;
        }
        return ZEstadoEnsayo.TERMINADO;
    }
